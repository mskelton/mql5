#ifndef SIGNAL_FR_AMA_H
#define SIGNAL_FR_AMA_H
...
CSignalFrAMA::CSignalFrAMA(void)
    : m_ma_period(12), m_ma_shift(0), m_ma_applied(PRICE_CLOSE),
      m_pattern_0(90), m_pattern_1(100), m_pattern_2(80), m_pattern_3(60) {
