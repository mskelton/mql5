...
CSignalAMA::CSignalAMA(void)
    : m_ma_period(10), m_ma_shift(0), m_period_fast(2), m_period_slow(30),
      m_ma_applied(PRICE_CLOSE), m_pattern_0(10), m_pattern_1(70),
      m_pattern_2(100), m_pattern_3(60) {
...
bool CSignalAMA::InitMA(CIndicators *indicators) {
  ...
  if (!m_ma.Create(m_symbol.Name(), m_period, m_ma_period, m_period_fast,
                   m_period_slow, m_ma_shift, m_ma_applied)) {
