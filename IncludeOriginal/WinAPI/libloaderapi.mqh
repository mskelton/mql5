...
HANDLE FindResourceExW(HANDLE module, const string type, const string name,
                       ushort language);
int FindStringOrdinal(uint find_string_ordinal_flags,
                      const string string_source, int source,
...
int EnumResourceLanguagesExW(HANDLE module, const string type,
                             const string name, PVOID enum_func, long param,
...
int EnumResourceTypesExW(HANDLE module, PVOID enum_func, long param, uint flags,
                         ushort lang_id);
