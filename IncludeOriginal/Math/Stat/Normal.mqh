...
double MathProbabilityDensityNormal(const double x, const double mu,
  ...
  return TailLogValue(M_1_SQRT_2PI * MathExp(-0.5 * y * y) / sigma, true,
                      log_mode);
}
...
bool MathProbabilityDensityNormal(const double &x[], const double mu,
  ...
  for (int i = 0; i < data_count; i++) {
    ...
    result[i] = TailLogValue(M_1_SQRT_2PI * MathExp(-0.5 * y * y) / sigma, true,
                             log_mode);
  }
  return true;
}
...
double MathCumulativeDistributionNormal(const double x, const double mu,
                                        const double sigma, int &error_code) {
  return MathCumulativeDistributionNormal(x, mu, sigma, true, false,
                                          error_code);
}
...
double MathQuantileNormal(const double probability, const double mu,
  ...
  if (MathAbs(q) <= 0.425) {
    r = 0.180625 - q * q;
    ppnd16 = q *
             (((((((normal_q_a7 * r + normal_q_a6) * r + normal_q_a5) * r +
                  normal_q_a4) *
                     r +
                 normal_q_a3) *
                    r +
               ...
               normal_q_a1) *
                  r +
              normal_q_a0) /
             (((((((normal_q_b7 * r + normal_q_b6) * r + normal_q_b5) * r +
                  normal_q_b4) *
                     r +
                 normal_q_b3) *
                    r +
    ...
    if (r <= 5.0) {
      r = r - 1.6;
      ppnd16 = (((((((normal_q_c7 * r + normal_q_c6) * r + normal_q_c5) * r +
                    normal_q_c4) *
                       r +
                   normal_q_c3) *
                      r +
                 ...
                 normal_q_c1) *
                    r +
                normal_q_c0) /
               (((((((normal_q_d7 * r + normal_q_d6) * r + normal_q_d5) * r +
                    normal_q_d4) *
                       r +
                   normal_q_d3) *
                      r +
      ...
      r = r - 5.0;
      ppnd16 = (((((((normal_q_e7 * r + normal_q_e6) * r + normal_q_e5) * r +
                    normal_q_e4) *
                       r +
                   normal_q_e3) *
                      r +
                 ...
                 normal_q_e1) *
                    r +
                normal_q_e0) /
               (((((((normal_q_f7 * r + normal_q_f6) * r + normal_q_f5) * r +
                    normal_q_f4) *
                       r +
                   normal_q_f3) *
                      r +
    ...
    if (prob == 0.0 || prob == 1.0) {
      ...
      if (MathAbs(q) <= 0.425) {
        ...
        if (r <= 5.0) {
          r = r - 1.6;
          ppnd16 =
              (((((((normal_q_c7 * r + normal_q_c6) * r + normal_q_c5) * r +
                   normal_q_c4) *
                      r +
                  normal_q_c3) *
                     r +
          ...
          r = r - 5.0;
          ppnd16 =
              (((((((normal_q_e7 * r + normal_q_e6) * r + normal_q_e5) * r +
                   normal_q_e4) *
                      r +
                  normal_q_e3) *
                     r +
