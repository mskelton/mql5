...
enum HARDWARE_COUNTER_TYPE { PMCCounter, MaxHardwareCounterType };
...
PVOID RtlLookupFunctionEntry(ulong control_pc, PVOID image_base,
                             UNWIND_HISTORY_TABLE &history_table);
void RtlUnwindEx(PVOID target_frame, PVOID target_ip,
                 EXCEPTION_RECORD &exception_record, PVOID return_value,
                 PVOID context_record, UNWIND_HISTORY_TABLE &history_table);
PVOID RtlVirtualUnwind(uint handler_type, ulong image_base, ulong control_pc,
                       PVOID function_entry, PVOID context_record,
                       PVOID &handler_data, PVOID establisher_frame,
                       KNONVOLATILE_CONTEXT_POINTERS &context_pointers);
PVOID RtlLookupFunctionEntry(ulong control_pc, uint &image_base,
                             UNWIND_HISTORY_TABLE &history_table);
void RtlUnwindEx(PVOID target_frame, PVOID target_ip,
                 EXCEPTION_RECORD &exception_record, PVOID return_value,
                 PVOID context_record, UNWIND_HISTORY_TABLE &history_table);
PVOID RtlVirtualUnwind(uint handler_type, uint image_base, uint control_pc,
                       PVOID function_entry, PVOID context_record,
                       PVOID &handler_data, uint &establisher_frame,
                       KNONVOLATILE_CONTEXT_POINTERS &context_pointers);
PVOID RtlLookupFunctionEntry(ulong control_pc, PVOID image_base,
                             UNWIND_HISTORY_TABLE &history_table);
void RtlUnwindEx(PVOID target_frame, PVOID target_ip,
